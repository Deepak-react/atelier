...
const UIUX = () => {
  ...
  return (
    ...
    <section className="serv-banner social-media-marketing">
        ...
        Boost Your Success with Atelier's Best Social Media Strategy Marketing Agency
        </h1>
    </section>
     ...
     Top Social Media Marketing Services for Brand Growth
        ...
        <div className="srv-detai-sec-contain">
            ...
            <p>We create customized strategies based on your business goals, audience, and industry trends to ensure that your social media efforts are aligned for success.</p>
            ...
            <p>Our team creates captivating, high-quality content that connects with your target audience, whether it’s visuals, videos, or written posts, strengthening brand loyalty and recognition.
            </p>
            ...
            <p>We run targeted social media ad campaigns on platforms like Facebook, Instagram, LinkedIn, and more to increase brand visibility and drive conversions.
            </p>
...
<div className="extra-cont-light-img">
  ...
  <div>
        <h4>Top LinkedIn Marketing Service Agency Unlock Professional Networking for B2B Success
